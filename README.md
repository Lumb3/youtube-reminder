I see that your README is functional but still has formatting issues, especially with step numbering, code blocks, and section separation. Here’s a **clean, fully GitHub-ready version** that fixes indentation, adds proper Markdown formatting, and ensures everything is easy to read and copy directly:
...
3. **Extension icon**
   ...
   **Note:** The extension only works on YouTube's **Watch Later** section. On other pages, it will look like this:
...
4. **Using the extension on Watch Later**
   When you open the Watch Later section, you will see this interface. Press the **yellow bookmark button** to add the current video to the extension:
